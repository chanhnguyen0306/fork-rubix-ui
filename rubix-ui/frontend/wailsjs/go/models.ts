...
export namespace appstore {
  ...
  export class EdgeReplaceConfig {
    app_name: string;
    file_name: string;
    restart_app: boolean;
    delete_file_from_assist: boolean;

    static createFrom(source: any = {}) {
      return new EdgeReplaceConfig(source);
    }
    ...
    constructor(source: any = {}) {
      ...
      this.restart_app = source["restart_app"];
      this.delete_file_from_assist = source["delete_file_from_assist"];
    }
  }
  ...
  export class EdgeReplaceConfigResp {
    app_name: string;
    // Go type: EdgeUploadResponse
    edge_upload_response?: any;
    restart_message?: string;

    static createFrom(source: any = {}) {
      return new EdgeReplaceConfigResp(source);
    }

    constructor(source: any = {}) {
      if ("string" === typeof source) source = JSON.parse(source);
      this.app_name = source["app_name"];
      this.edge_upload_response = this.convertValues(
        source["edge_upload_response"],
        null
      );
      this.restart_message = source["restart_message"];
    }
...
export namespace installer {
  ...
  export class InstalledServices {
    ...
    constructor(source: any = {}) {
      ...
      this.app_name = source["app_name"];
      this.service_name = source["service_name"];
      this.app_status = this.convertValues(
        source["app_status"],
        systemctl.SystemState
      );
    }
...
export namespace main {
  ...
  export class EdgeDeviceInfo {
    ...
    constructor(source: any = {}) {
      ...
      this.installed_apps = this.convertValues(
        source["installed_apps"],
        InstalledApps
      );
      this.apps_available_for_install = this.convertValues(
        source["apps_available_for_install"],
        AppsAvailableForInstall
      );
    }
