...
export namespace assistmodel {
	...
	export class HostSchema {
	    ...
	    password: any;
	    // Go type: schema.RubixEdgeToken
	    rubix_edge_token: any;
	    // Go type: schema.FlowFrameworkToken
	    flow_framework_token: any;
	    required: string[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.rubix_edge_token = this.convertValues(source["rubix_edge_token"], null);
	        this.flow_framework_token = this.convertValues(source["flow_framework_token"], null);
