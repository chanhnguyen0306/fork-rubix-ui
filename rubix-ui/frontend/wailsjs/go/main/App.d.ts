...
export function WiresBackupSave(arg1:string,arg2:string):Promise<storage.Backup>;
...
export function WiresBackup(arg1:string,arg2:string):Promise<any>;

export function WiresFileUpload(arg1:string,arg2:string,arg3:string):Promise<any>;
